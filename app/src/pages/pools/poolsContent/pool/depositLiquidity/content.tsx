        ...
        <>
            ...
            <Box className={classes.depositWrapper}>
                <Box className={classes.depositBox}>
                    <Box className={classes.depositAmount}>
                        <Box className={classes.amountDetail}>
                            <Typography>Balance: <span>201,123,698.8091</span></Typography>
                            <Button>Max</Button>
                        </Box>
                    ...
                    <Box className={classes.depositAmount}>
                        <Box className={classes.amountDetail}>
                            <Typography>Balance: <span>298.8091</span></Typography>
                            <Button>Max</Button>
                        </Box>
                        <Box className={classes.amountInputWrapper}>
                            <InputBase
                    ...
                    <Typography className={classes.estimation}>Est. Earn After double-dipping</Typography>
                    <Box className={classes.depositItem}>
                ...
                <Box className={classes.depositBox}>
                    ...
                    <Box className={classes.priceToggleWrapper}>
                        <FormControlLabel
                            control={<Switch checked={priceRange} onChange={(event: React.ChangeEvent<HTMLInputElement>) => setPriceRange(event.target.checked)} />}
                    ...
                    {priceRange ? (
                        ...
                        <Box className={classes.concentratedLiquidity}>
                            ...
                            <Typography>
                                You can establish a centralized position by <span>setting the price range</span>.
            ...
            <Box className={classes.footer}>
                <Box className={classes.supportDoubleDip}>
                    ...
                    <Typography>after depositing, pls move to "double-dip" for the project token rewards!</Typography>
                </Box>
                <Button className={classes.footerButton} disabled>Enter an amount</Button>
            </Box>
        </>
    )
}
