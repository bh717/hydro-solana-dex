...
use crate::programs::fees::percentage_fee::FeeCalculator;
...
impl SwapCalculator {
    ...
    pub fn swap_x_to_y_hmm(&self, delta_x: &Decimal) -> Result<SwapResult, SwapCalculatorError> {
        ...
        let fee_result = self.fee.compute_fees(delta_x).expect("fees");
    ...
    pub fn swap_y_to_x_hmm(&self, delta_y: &Decimal) -> Result<SwapResult, SwapCalculatorError> {
        ...
        let fee_result = self.fee.compute_fees(delta_y).expect("fees");
