        ...
        <Box className={classes.poolContainer}>
            <Box className={classes.badgeContainer}>
                ...
                <span className={classes.badge}>
                    10 HYSD per day for each $1000
                </span>
            </Box>
            <Box className={cn(classes.poolWrapper, { 'hasDoubleDip': isDoubleDip, 'alignTop': type === 'liquidity' })}>
                {type === 'all' && (
                    <>
                    ...
                    <>
                        <Box className={classes.poolContent}>
                            ...
                            <Box className={classes.poolDetail}>
                                <Box className={classes.liquidityDetail}>
                                    <Typography>Your Liquidity: <span>476 LP Token</span> ≈ $100</Typography>
                                    {inRange === undefined ? (
                                        <Typography>You did not set a price range. <span className={cn(classes.underline, classes.pointer)}>{ 'Learn more>' }</span></Typography>
                                    ) : (
                            ...
                            {inRange !== undefined && (
                                <Box className={cn(classes.rangeHint, { 'goodRange': inRange === true, 'badRange': inRange === false})}>
                        ...
                        {isDoubleDip === true && (
                            <Box className={classes.doubleDipHint}>
                                <Typography>Stake your LP tokens in the <span>Double-Dip</span> tab to earn additional SOL tokens.</Typography>
                            </Box>
                        )}
                    </>
                )}
                {type === 'doubleDip' && (
                    <>
                        ...
                        <Box className={classes.poolButtons}>
                            {hasUndip && (
                                <Button className={classes.borderButton} style={{ marginRight: '12px' }}>
                                    Harvest & Undip
                                </Button>
                            )}
